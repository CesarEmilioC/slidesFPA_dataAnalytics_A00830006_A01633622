...
\newcommand{\figcaption}[1]{%
  \begin{center}%
    \vspace{3pt}%
    {\color{TecGold}\rule{0.48\linewidth}{0.4pt}}\par\vspace{2pt}%
    {\scriptsize\color{TecGray}#1}%
  \end{center}%
}
...
\vspace{2pt}
\begin{center}
  \includegraphics[width=0.95\linewidth,height=0.60\textheight,keepaspectratio]{sector_volatility.png}
\end{center}
\figcaption{\textbf{XLP} (Consumer Staples) -- low \quad\textcolor{TecGold}{$\bullet$}\quad
...
\end{center}
\figcaption{\good{SP500\,+\,RF\,+\,Sentiment}: 0.57 Acc / 0.68 F1 / 0.51 AUC (+0.06/+0.08/+0.04).
